...
import { Plus, Edit, Power, Upload, CheckCircle, AlertCircle, MapPin } from 'lucide-react';
          ...
          try {
            if (type === 'secao') {
              const secaoData = results.data.map((row: any) => ({
                ...
                bairro: row.Bairro || '',
                cidade: row.Cidade || row.Municipio || row.Município || null,
                ano
              }));
                ...
                <TableRow key={candidato.id}>
                  ...
                  <TableCell>
                    <div className="flex space-x-2">
                      ...
                      {/* Ir para a PÁGINA COMPLETA do candidato */}
                      <Button 
                        variant="outline" 
                        size="sm" 
                        onClick={() => navigate(`/dashboard/candidato/${candidato.id}`)}
